...
export const Map = ({myPosition}: MapProps) => {
    return (
        <MapContainer center={{ lat: myPosition.lat, lng: myPosition.lng }} zoomControl={false} zoom={13} style={{ height: '100vh' }}>
            ...
            <MarkerClusterGroup>
                ...
                {/* <Marker key={pos.user_id} position={{ lat: pos.lat, lng: pos.lng }} icon={icon2} > */}
                <Marker position={{ lat: 59.831367, lng: 30.513092 }} icon={icon2} >
                    <Popup>
